...
import { useWells } from "@/hooks/use-supabase-data-mock"
...
export default function WellsPage() {
  ...
  const handleCreateWell = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to create well (Demo Mode)",
        variant: "destructive",
      })
    } finally {
      setIsCreating(false)
                          ...
                          <TableRow key={well.id} className="hover:bg-muted/50">
                            ...
                            <TableCell>
                              <div className="flex items-center gap-1">
                                ...
                                <span className="text-sm">{well.daily_production || 0} bbl/day</span>
                              </div>
                            </TableCell>
                            <TableCell>
                              <div className="flex items-center gap-1">
                                <DollarSign className="h-3 w-3 text-green-600" />
                                <span className="text-sm">${(well.monthly_revenue || 0).toLocaleString()}/mo</span>
                              </div>
                            </TableCell>
                            <TableCell>
                              <DropdownMenu>
